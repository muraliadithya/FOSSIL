...
while True:
    lemma = getSygusOutput(elems, fcts, vc_axioms, fct_axioms, recdefs_macros, recdefs,
                           ...
                           'preamble_sdlist-dlist.sy', 'grammar_sdlist-dlist.sy', 'out_sdlist-dlist.sy')
