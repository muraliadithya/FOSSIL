...
orig_model = getFalseModel(axioms_z3, fcts_z3, valid_lemmas, unfold_recdefs_z3, deref, const, vc(x,y,ret), True)
if orig_model == None:
    ...
    for lemma in lemmas:
        ...
        if false_model_z3 != None:
            ...
            if use_cex_models:
                ...
                config_params['cex_models'] = cex_models
                # correct_lemma = Implies(slseg_y(fresh), lseg_y(fresh))
