...
from naturalproofs.decl_api import get_boolean_recursive_definitions, is_var_decl
from naturalproofs.pfp import make_pfp_formula
from naturalproofs.prover_utils import instantiate, get_foreground_terms
